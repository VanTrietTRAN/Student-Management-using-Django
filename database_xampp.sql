...
-- ===================================================
-- BƯỚC 1: Tạo các bảng cơ bản (không có foreign key)
-- ===================================================

-- django_content_type (cần tạo đầu tiên)
...
-- auth_permission (cần tạo trước auth_group_permissions)
...
-- auth_group_permissions (sau khi đã có auth_permission và auth_group)
...
-- ===================================================
-- BƯỚC 2: Tạo các bảng Student Management App
-- ===================================================

-- student_management_app_customuser (tạo trước các bảng phụ thuộc)
...
-- student_management_app_customuser_user_permissions
...
-- django_admin_log (phụ thuộc vào customuser và content_type)
