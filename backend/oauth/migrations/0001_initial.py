    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('teacher', 'Giảng viên'), ('student', 'Sinh viên'), ('training_staff', 'Nhân viên phòng đào tạo'), ('student_affairs', 'Nhân viên phòng công tác sinh viên')], default='student', max_length=20, verbose_name='Loại người dùng')),
                ...
                ('roles', models.ManyToManyField(blank=True, to='oauth.role', verbose_name='Vai trò')),
            ],
            options={
