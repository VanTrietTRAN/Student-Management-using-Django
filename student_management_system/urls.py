...
urlpatterns = [
    ...
    path('staff_my_subjects', StaffViews.staff_my_subjects, name="staff_my_subjects"),
    path('staff_view_class_students/<str:subject_id>', StaffViews.staff_view_class_students, name="staff_view_class_students"),
    path('staff_enter_grades/<str:subject_id>', StaffViews.staff_enter_grades, name="staff_enter_grades"),
    path('staff_save_grades', StaffViews.staff_save_grades, name="staff_save_grades"),
    path('staff_manage_description/<str:subject_id>', StaffViews.staff_manage_description_new, name="staff_manage_description"),
    path('staff_save_description', StaffViews.staff_save_description, name="staff_save_description"),
    path('staff_send_notification', StaffViews.staff_send_notification, name="staff_send_notification"),
    path('staff_send_notification_save', StaffViews.staff_send_notification_save, name="staff_send_notification_save"),
    path('export_subject_grades/<str:subject_id>', StaffViews.export_subject_grades, name="export_subject_grades"),
